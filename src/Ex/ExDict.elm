...
-}
type ExDict k v
    = RBNode_elm_builtin NColor k v (ExDict k v) (ExDict k v)
    | RBEmpty_elm_builtin
...
removeMin : ExDict k v -> ExDict k v
removeMin dict =
  case dict of
...
-}
map : (k -> a -> b) -> ExDict k a -> ExDict k b
map func dict =
  case dict of
    RBEmpty_elm_builtin ->
      RBEmpty_elm_builtin
